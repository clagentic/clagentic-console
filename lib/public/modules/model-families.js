...
export var CLAUDE_MODEL_FAMILIES = ["opus", "sonnet", "haiku", "fable"];
 ...
 */
export function parseClaudeModelVersion(modelId, description) {
 ...
 */
export function claudeDisplayName(modelId, description) {
