...
export function initConnection() {
  ...
  store.subscribe(['connected', 'processing'], function (state, prev) {
    ...
    // state.processing is this client's own live turn-in-flight signal —
    // always tone 'self' — routed through the same derivation every other
    // dot uses rather than writing '.processing' independently.
