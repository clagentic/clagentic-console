...
// --- App module imports ---
import { scrollToBottom, addToMessages, addUserMessage, addSystemMessage, appendDelta, finalizeAssistantBlock, addConflictMessage, addContextOverflowMessage, showSuggestionChips, armStickyBottom, disarmStickyBottom, removePreThinking } from './app-rendering.js';
...
import { getModelEffortLevels, accumulateUsage, getSessionUsage, setSessionUsage, updateUsagePanel, accumulateContext, updateContextPanel, renderCtxPopover, updateStatusPanel } from './app-panels.js';
...
import { handleRateLimitEvent, updateRateLimitUsage, addScheduledMessageBubble, removeScheduledMessageBubble, clearScheduledMessage, handleFastModeState, restoreRateLimitStateForSession } from './app-rate-limit.js';
...
export function processMessage(msg) {
    ...
    switch (msg.type) {
      ...
      case "hub_recent_sessions":
        handleHubRecentSessions(msg);
        break;
      ...
      case "rename_custom_icon_result":
        handleRenameCustomIconResult(msg);
        break;
      ...
      // --- Team activity ---
      case "team_state":        handleTeamState(msg); break;
      case "team_member_update": handleTeamMemberUpdate(msg); break;
      case "team_task_update":   handleTeamTaskUpdate(msg); break;
      case "team_message":       handleTeamMsg(msg); break;
      case "team_gone":          handleTeamGone(msg); break;
      ...
      case "daemon_config_changed":
        updateDaemonConfig(msg);
        break;

      case "lite_project_status":
        handleLiteProjectStatus(msg);
        break;

      case "lite_enroll_result":
        handleLiteEnrollResult(msg);
        break;

      case "lite_unenroll_result":
        handleLiteUnenrollResult(msg);
        break;
    }
}
