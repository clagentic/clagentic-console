...
function renderMcpServerList() {
  ...
  steps.appendChild(renderStep({
    ...
    desc: step1Done
      ? "Connected"
      : "Required to bridge your browser with Clagentic:Console.",
  ...
  if (step3Done) {
    ...
    step3Desc = "Add servers from the Clagentic:Console Chrome Extension popup using the + button, or import an existing config file.";
  } else {
