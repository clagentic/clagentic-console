...
function showColorPicker(anchor, noteEl, noteId) {
  ...
  // Position relative to anchor, clamped to the viewport on all four edges
  // (lr-a10a: this popover previously had no clamp at all).
  positionPopover(picker, anchor, { placement: "below", gap: 4 });
