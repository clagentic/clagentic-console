...
// list and resets the fingerprint so the next session_list from the new
// project is always rendered (never skipped by the fingerprint guard).
export function resetSessionList() {
  cachedSessions = [];
  _sessionListFingerprint = "";
  renderSessionList(null);
}
