...
export function resetClientState() {
  ...
  // Clear the session list immediately so the sidebar doesn't show the previous
  // project's sessions while waiting for the new project's session_list from
  // the server. Resets the fingerprint too so the incoming list is never skipped.
