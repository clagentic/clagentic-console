...
export function renderProjectList() {
  ...
  // is THIS client's own live turn-in-flight signal (set by setStatus() in
  // app-connection.js) — always tone 'self', it can only ever be about the
  // viewing user's own connection. lr-66c118: routed through the same
  // derivation as every other dot rather than writing '.processing' as an
  // independent 3rd state source (alongside the session-level processing
  // flag and setActivity).
