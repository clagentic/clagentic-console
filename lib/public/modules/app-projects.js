...
export function resetClientState() {
  ...
  setRewindMode(false);
  // lr-66c118: the setActivity clear call is removed — setActivityEl(null)
  // above already nulls the activity-widget ref, and
  // getMessagesEl().innerHTML = "" already wiped the DOM element itself, so
  // calling it here was redundant with the widget's own reactive clear
  // (see app-favicon.js).
  setStatus("connected");
