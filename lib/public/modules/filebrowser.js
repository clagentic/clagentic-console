...
// Read pendingNavigate without consuming it.  Use this when you need to
// inspect the pending nav target but must not clear it yet (e.g. the
// history_meta guard that runs before history_done actually navigates).
