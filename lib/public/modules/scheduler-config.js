...
export function setupCreateModal() {
  ...
  endBtn.addEventListener("click", function (e) {
    ...
    if (endList.classList.contains("hidden")) {
      ...
      // Four-edge clamp (lr-a10a): the prior bottom-flip-only logic could
      // leave the flipped dropdown with top < 0 when the button sits near
      // the top of a short viewport.
      positionPopover(endList, endBtn, { placement: "below", gap: 4 });
    } else {
