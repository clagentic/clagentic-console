...
export function updatePageTitle() {
  ...
  if (ctx.headerTitleEl) {
    ctx.headerTitleEl.textContent = sessionTitle || ctx.projectName || "Clagentic:Console";
  }
  ...
  if (ctx.projectName && sessionTitle) {
    ...
    document.title = ctx.projectName + " - Clagentic:Console";
  } else {
    document.title = "Clagentic:Console";
  }
}
