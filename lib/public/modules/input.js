...
export function autoResize() {
  ...
  if (lines === autoResizeLastLines) {
    ...
    // Throttle to every 8 calls so single-line typing pays this cost at
    // most once every ~8 keypresses rather than every keypress.
    autoResizeSoftWrapTick = (autoResizeSoftWrapTick + 1) % 8;
