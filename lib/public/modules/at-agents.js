...
function _ensureMenu() {
  ...
  // #input-wrapper has position:relative and is the direct parent of #mention-menu
  // and #slash-menu. Attaching here ensures bottom:100% positions the menu above
  // the input row, matching the other menus. #input-area has no position:relative
  // and would mis-place the absolute element.
  var inputWrapper = document.getElementById("input-wrapper");
  if (inputWrapper) {
    inputWrapper.appendChild(_menuEl);
  } else {
