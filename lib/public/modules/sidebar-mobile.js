...
export function openMobileSheet(type) {
  ...
  if (type === "projects") {
    ...
    // Knowledge list request removed: mates
...
function renderSheetSettings(listEl) {
  ...
  // Brand switch button (Clagentic / Classic)
  var currentBrand = getBrand();
  var nextBrand = currentBrand === "classic" ? "clagentic" : "classic";
  var brandLabel = currentBrand === "classic" ? "Clagentic" : "Classic";
  var brandBtn = document.createElement("button");
  brandBtn.className = "mobile-more-item";
  brandBtn.innerHTML = '<i data-lucide="palette"></i><span class="mobile-more-item-label">Switch to ' + brandLabel + ' brand</span>';

  brandBtn.addEventListener("click", function () {
    var nb = getBrand() === "classic" ? "clagentic" : "classic";
    setBrand(nb);
    var nl = nb === "classic" ? "Clagentic" : "Classic";
    brandBtn.innerHTML = '<i data-lucide="palette"></i><span class="mobile-more-item-label">Switch to ' + nl + ' brand</span>';
    refreshIcons();
  });

  listEl.appendChild(brandBtn);
