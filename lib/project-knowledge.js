 ...
 *
 * Note: knowledge_promote and knowledge_depromote were mate-only features (lr-316f).
...
function attachKnowledge(ctx) {
  ...
  function handleKnowledgeMessage(ws, msg) {
    ...
    // knowledge_promote and knowledge_depromote are no-op stubs (mate-only feature, lr-316f)
