 ...
 *
 * lr-2ea2a7: iterates the heap array backward from its end — tolerant of a
 * trimmed head by construction (only ever wants the most recent ~800 chars,
 * which live in the retained tail window regardless of how much of the
 * session's full history has been trimmed off the front).
 *
