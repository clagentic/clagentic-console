...
// lr-5e70: rebuildable-cache drop hook consumed by lib/memory-shed.js on a
// MemoryHigh watermark crossing. Every entry is a TTL-cached (5 min) fetch
// of a skills.sh proxy response — safe to drop unconditionally, since the
// next request for any key just re-fetches and re-populates it.
function dropSkillsCache() {
  skillsCache = {};
}
...
module.exports = { attachSkills: attachSkills, dropSkillsCache: dropSkillsCache };
