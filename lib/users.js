...
function saveUsers(data) {
  // Fire-and-forget async write through store.js (atomic, queued, 0o600).
  // Callers within this module are synchronous; converting them all to async
  // is deferred (TODO(lr-b372): convert users.js callers to async).
