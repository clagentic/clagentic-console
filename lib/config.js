...
function ensureConfigDir() {
  ...
  // Remove stale old socket file left by pre-1.5 daemons (lr-88fe moved the
  // socket into console/). We unlink rather than warn-and-leave so the message
  // appears once, not on every subsequent CLI invocation.
  if (process.platform !== "win32") {
