...
var { DEFAULT_MEM_AVAILABLE_MIN_MB, DEFAULT_TOKENS_PER_MB_HEADROOM } = require("./sdk-bridge");
...
var tlsOptions = null;
if (config.tls) {
  // User cert (~/.clagentic/certs/key.pem + cert.pem, generated by mkcert or supplied manually)
  var os = require("os");
