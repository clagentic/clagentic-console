    ...
    sendTo(ws, {
      ...
      sessions: allSessions.map(function (s) {
        ...
        return {
          ...
          // Keep this aligned with sessions.js:mapSessionForClient — fields
          // omitted here vanish from the row when this connect-time path runs
          // instead of the standard broadcast.
