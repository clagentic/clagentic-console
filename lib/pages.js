...
<div class="step-card" id="step-tailscale">
  ...
  <div class="step-desc">Tailscale creates a private VPN so you can access Clagentic:Console from anywhere. It needs to be installed on <b>both</b> the server (the machine running Clagentic:Console) and this device.</div>

  <div class="instruction"><div class="inst-num">1</div>
    <div class="inst-text"><b>Server:</b> Install Tailscale on the machine running Clagentic:Console.
