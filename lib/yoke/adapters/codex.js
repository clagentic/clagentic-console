...
function createCodexAdapter(opts) {
  ...
  function buildEnrichedSlashCommands(skillNames, cwd) {
    ...
    var fsSkillsMeta;
    try {
      fsSkillsMeta = discoverSkillsWithMeta(effectiveCwd);
    } catch (e) {
      fsSkillsMeta = [];
    }
    var skillMetaMap = {};
  ...
  function buildReadyResponse(skillNames, cwd) {
    return {
      models: _cachedModels,
      defaultModel: _defaultModel,
      skills: skillNames || [],
      slashCommands: buildEnrichedSlashCommands(skillNames, cwd),
      fastModeState: null,
      capabilities: {
        thinking: true,
        betas: false,
  ...
  var adapter = {
    ...
    init: function(initOpts) {
      ...
      _initPromise = (async function() {
        ...
        return buildReadyResponse(skillNames, _cwd);
      })();
